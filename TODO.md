 ...
 * @LastEditTime: 2020-04-30 20:57:50
 * @LastEditors: Juck
 * @Description: 
...
3. 菜单收起 —权限—文件属主—文件属组— 文件名——时间——类型——标题等其他属性放入右键的属性菜单 new多个桌面图标或者其他app，并在构造函数中设置默认参数，
4. 搜索文件 + 文件图标根据后缀加载（专门的文件夹）
5. 视频，图片，各种文档等查看器。(调用接口)新打开的窗口作为组件渲染进来iframe
6. dplayer
