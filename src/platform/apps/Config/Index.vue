 ...
 * @LastEditTime: 2020-04-29 16:18:44
 * @LastEditors: Juck
...
export default {
  ...
  created() {
    ...
    const appsParameter = [
      ...
      [1, 'shell', '终端', 'Shell', '@/platform/apps/Shell', '/assets/apps/Shell/logo.png', true, true, false, false, true, false, 'default', false, 60, 60, 400, 400, 'V0.0.1', 'Juck'],
